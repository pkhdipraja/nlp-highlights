...
%Illustration of encoder and decoder model
%4 layers deep models, use lstm. paper that shows lstm is better than gru
% formula, beam search
% experiment in paper, model analysis pca

\section*{Seq2Seq Limitation and Recent Advances} % & related work. also include problems with Seq2Seq? also improvement to seq2seq?
