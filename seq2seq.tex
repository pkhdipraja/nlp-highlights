...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.92]{reverse}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.97]{seq2seq_model}
...
\begin{figure}[ht]
\centering
\includegraphics[scale=0.92]{birnn}
